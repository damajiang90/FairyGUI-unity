                ...
                if (batchElement != null)
                {
                    ...
                    if (childOutlineChanged)
                    {
                        ...
                        if (child._clampInParentBound)
                        {
                            ...
                            batchElement.bounds[0] = Mathf.Max(parentRect.xMin, rect.xMin);
                            batchElement.bounds[1] = Mathf.Max(parentRect.yMin, rect.yMin);
                            batchElement.bounds[2] = Mathf.Min(parentRect.xMax, rect.xMax);
                            batchElement.bounds[3] = Mathf.Min(parentRect.yMax, rect.yMax);
                        }
                        else
                        {
